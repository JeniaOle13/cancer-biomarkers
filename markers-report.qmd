...
[Figure 1](figures/sample_map.pdf)
...
[Figure 2](figures/catalog_picture.png)
![Figure 2](figures/catalog_picture.png)
...
# pdf(file = "figures/maaslin_phylum_heatmap.pdf", width = 5, height = 3)
# maaslin_phylum_heatmap
# dev.off()
```

[Figure 8](figures/maaslin_phylum_heatmap.pdf)
...
# pdf(file = "figures/maaslin_genus_heatmap.pdf", width = 5, height = 5)
# maaslin_genus_heatmap
# dev.off()
```

[Figure 9](figures/maaslin_genus_heatmap.pdf)
...
# pdf(file = "figures/maaslin_species_heatmap.pdf", width = 6, height = 5)
# maaslin_species_heatmap
# dev.off()
```

[Figure 10](figures/maaslin_species_heatmap.pdf)
