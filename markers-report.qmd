...
39) [Pasolli, Edoardo, et al. "Extensive unexplored human microbiome diversity revealed by over 150,000 genomes from metagenomes spanning age, geography, and lifestyle." Cell 176.3 (2019): 649-662.](https://www.sciencedirect.com/science/article/pii/S0092867419300017)
40) [Carlino, Niccolò, et al. "Unexplored microbial diversity from 2,500 food metagenomes and links with the human microbiome." Cell 187.20 (2024): 5775-5795.](https://pubmed.ncbi.nlm.nih.gov/39214080/)
...
<p style="text-align: justify;">
Gene set enrichment analysis revealed enrichment patterns based on taxonomic features (phylum, genus) and microbial origins – specifically, body sites excluding the intestine (mouth, skin, vagina) and the environment (food). OGU identified with 98% nucleotide identity were grouped by taxonomy or other characteristics to facilitate the study of enrichment within specific groups. According to obtained results, Bacteroidetes phylum was upregulated in R group as well as Proteobacteria in NR group (GSEA adj.p < 0.01). Стоит отметить, что list of core enrichment OGU of Proteobacteria included potential opportunistic species such as *Klebsiella quasipneumoniae*, *Klebsiella michiganensis*, *Enterobacter ludwigii*, *Enterobacter kobei*, *Citrobacter youngae*, *Citrobacter portucalensis*, *Citrobacter freundii*, *Haemophilus sp001815355*. At the genus level, *Blautia*, *Bacteroides*, *Fusicatenibacter*, *Gemmiger*, and *Faecalibacterium* were enriched in R group as well as *Veillonella*, *Prevotella*, *Dysosmobacter*, *Acetatifactor* were enriched in NR group (GSEA adj.p < 0.01).
<p>

<p style="text-align: justify;">
Clustering 3,816 OGUs from this study with 9,412 MAGs derived from different body sites and 10,112 food-derived MAGs revealed that 91 OGUs exhibited complementarity to food-derived microbes, and 293 were complementary to those from non-intestinal sources, at 95% nucleotide similarity, which corresponds to the species level. Based on the data, NR-linked OGUs were enriched in oral and food-derived microbial communities. Core food-derived OGUs comprised *Bifidobacterium animalis*, *C. freundii*, *E. kobei*, *Enterococcus faecalis*, *Enterococcus faecium*, *Escherichia coli*, *K. michiganensis*, *K. quasipneumoniae*, *Lactobacillus gasseri*, *Limosilactobacillus reuteri*, and *Megasphaera elsdenii*, showing substantial overlap with core enrichment patterns observed in Proteobacteria. Core enrichment patterns within the oral cavity included OGU representatives of Veillonellales and Enterobacterales, specifically *Anaeroglobus micronuciformis*, *Escherichia coli*, *Veillonella parvula*, and *Haemophilus* sp001815355.
<p>
...
datatable(core_enrichment_phylum_1, 
          caption = "Table 8. GSEA results phylum level - Bacteroidetes core enrichment.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(core_enrichment_phylum_2, 
          caption = "Table 9. GSEA results phylum level - Proteobacteria core enrichment.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(fgsea_genus_df[1:8], 
          caption = "Table 10. GSEA results genus level.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(fgsea_food_df[1:8], 
          caption = "Table 11. GSEA results: food.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(core_enrichment_food, 
          caption = "Table 12. GSEA results: food - core enrichment.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(fgsea_bodysite_df[1:8], 
          caption = "Table 13. GSEA results: bodysite.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(core_enrichment_bodysite, 
          caption = "Table 14. GSEA results: bodysite - core enrichment.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(fgsea_cazy_df[1:8], 
          caption = "Table 15. GSEA results: CAZy.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
datatable(core_enrichment_GH, 
          caption = "Table 15. GSEA results: CAZy - core enrichment.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
```{r fig.width=4.5, fig.height=3.5}
#| echo: false
#| fig-cap: Figure 9. GSEA results CAZy.
gsea_cazy_plot
```
...
```{r fig.width=6, fig.height=4}
#| echo: false
#| fig-cap: Figure 10. Links between CAZy core enrichment GH and marker OGU.
cazy_barplot
```
...
datatable(fgsea_kegg_df[c(1,11,2:8)], 
          caption = "Table 15. GSEA results: KEGG.",
          style = "bootstrap5", 
          extensions = 'Buttons', 
          options = list(dom = 'lBfrtip',
                         buttons = c('csv', 'excel')))
...
#| echo: false
#| fig-cap: Figure 11. GSEA results CAZy.
gsea_kegg_plot
```
...
#| echo: false
#| fig-cap: Figure 12. GSEA results CAZy.
kegg_barplot
```